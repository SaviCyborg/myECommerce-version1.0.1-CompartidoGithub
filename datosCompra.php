...
<head>
    ...
    <link rel="stylesheet"  type="text/css" href="estilos/datosCompra.css">
    <title>Datos para realizar la Compra</title>
</head>
<body>
    <a id="ainicio" href="indexUsuarioRegistrado.php">Pagina de Inicio</a>
<?php
session_start();
...
?>
    <p class="info">
        Por favor realice el pago y envíe un recibo o captura de pantalla
        a nuestro correo ######@gmail.com <br> 
        Coloque sus datos (cédula, nombre, número de contacto) en el contenido del mensaje (o correo) para realizar la verificación<br>
        Solo necesita enviar el recibo de pago con sus datos
        a nuestro correo y en breve la pagina le informará que la
        compra fue exitosa. Para más información llámenos al 0414-###-##-##<br><br>
        Horarios: De lunes a viernes de 8 am a 5 pm. Sabados y domingos de 8 am a 2 pm.<br><br>
        Pago Móvil <br><br>
        Banco: &nbsp Banesco <br>
        celular: &nbsp 0414-###-##-##<br>
        CI: &nbsp V-#.###.###<br>
        Correo: &nbsp ######@gmail.com<br><br>
        Transferencia: <br>
        Banco: &nbsp Banesco <br>
        Nº de Cuenta: &nbsp 0000-0000-0000-0000-0000<br>
        Nombre: &nbsp ######<br>
        CI: &nbsp V-#.###.###<br>
        Correo: &nbsp ######@gmail.com
    </p>
                ...
                <div id="divDelFooter1" >
                    <div id="divDelFooter">
                        <p class="footer1">
                            ...
                            <a href="#" class="las_a_DelFooter" target="blank">@SaviCyborg</a></br>
