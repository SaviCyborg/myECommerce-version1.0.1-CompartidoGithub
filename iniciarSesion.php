    ...
    if(!empty($_POST)){
        if (isset($_POST['botonInicioSesion'])) {
            ...
            if ($row) {
                ...
                header("Location:indexUsuarioRegistrado.php");
            }else{
...
?>
    <body>
        <form class="form" action="iniciarSesion.php" method="post">
            ...
            <p class="form__paragraph">¿Aún no tienes una cuenta? &nbsp&nbsp<a href="registrate.php" class="form__link">Entra aquí</a></p>
        ...
        <script src="codigojs/codigoIniciarSesion.js"></script>
    </body>
</html>
