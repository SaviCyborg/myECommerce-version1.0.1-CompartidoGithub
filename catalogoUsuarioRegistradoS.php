...
<head>
    ...
    <link rel="stylesheet"  type="text/css" href="estilos/catalogoUsuarioRegistradoS.css">
...
?>
    ...
    <aside id="aside" class="desplegar">
        <div class="container-svg">
            <div>
                ...
                <a href="indexS_UsuarioRegistrado.php">Inicio</a>
            </div>
            <div>
            ...
            <div>
                ...
                <a href="galeriaS_UsuarioRegistrado.php">Galería</a>
            </div>
        ...
        <div class="container-svg">
            <div>
                ...
                <a href="ubicacionS.php">Ubicación</a>
            </div>
            <div>
            ...
            <div>
                ...
                <a href="favoritosS.php">Favoritos</a>
            </div>
            <div>
    ...
    <header id="header">
        ...
        <div id="logo" class="logo-place">
            <img  id="imagen-logo" src="logo/savilogo(width300pxHeight300)T.png" width="50px" height="50px">
        </div>
        <div id="searchplace" class="search-place" >
            <form id="primerFormulario" action="catalogoUsuarioRegistradoS.php" method="get" >
                <input type="text" id="idbusqueda" placeholder="Buscar" name="textoBuscarNombre">
                <button id='bt-search' class="btn-search" title="Buscar" name="botonBusqueda"><i ><svg id="boton-buscar-icon" fill="#000000"   viewBox="0 0 50 50" width="25px" height="25px"><path d="M 21 3 C 11.601563 3 4 10.601563 4 20 C 4 29.398438 11.601563 37 21 37 C 24.355469 37 27.460938 36.015625 30.09375 34.34375 L 42.375 46.625 L 46.625 42.375 L 34.5 30.28125 C 36.679688 27.421875 38 23.878906 38 20 C 38 10.601563 30.398438 3 21 3 Z M 21 7 C 28.199219 7 34 12.800781 34 20 C 34 27.199219 28.199219 33 21 33 C 13.800781 33 8 27.199219 8 20 C 8 12.800781 13.800781 7 21 7 Z"/></svg></i></button>
            </form>
        </div>
        <div id="optionplace" class="options-place" >
            ...
            <div id="divUsuario" class="item-option" title="<?php echo  $nombreUsuario; ?>">
                <a href="#">
                    <i>
    ...
    <div id="listaCategorias" class="lista_categorias" width="240px" height="60px">
        <form action="catalogoUsuarioRegistradoS.php" method="get"  >
                            ...
                            <form class="formulario_producto" action="catalogoUsuarioRegistradoS.php" method="get" with='40px' height='40px'>
                                ...
                                <button class="botonFavoritos" type="submit" value="" name="botonFavoritos">
                                    <?php
                                        ...
                                        $queryS = "SELECT `favoritos`
                                        FROM `favoritos_$usuarioS`
                                        WHERE `favoritos`='$valorABuscar';
                                        ";
                                        $result2 = mysqli_query($conexion3,$queryS);
                                ...
                                <button class="botonQuitarFavorito"  name="quitarFavorito" value="<?php echo $row['nombre'];?>">Quitar</button>
                            </form>
                            <img   src='imagenesproductos/<?php echo $row['imagen']; ?>' width="75px" height="100px">
                            <div  class="title-anddetail" >
                                &nbsp<?php echo $row['nombre']; ?> <br><br>
                                &nbsp&nbsp<?php echo $row['categoria']; ?><br><br>
                                &nbsp&nbsp&nbsp $/ <?php echo $row['precioVenta']; ?>.
                                
                                <span class="spanDelPrecio"  >99</span>
                            </div>
    ...
    <script src="codigojs/catalogoUsuarioRegistradoS.js "></script>
</body>
</html>