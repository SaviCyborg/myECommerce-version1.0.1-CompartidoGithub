...
<head>
    ...
    <link rel="stylesheet"  type="text/css" href="estilos/galeriaUsuarioRegistrado.css">  
</head>
<body>
<?php
    session_start();
...
?>
    ...
    <aside id="aside" class="desplegar">
        <div class="container-svg">
            ...
            <div>
                ...
                <a href="catalogoUsuarioRegistrado.php">Catálogo</a>
            </div>
            <div>
    ...
    <header id="header">
        ...
        <div id="optionplace" class="options-place" width='' height=''>
            ...
            <a href="indexUsuarioRegistrado.php" id="divboton-inicio" class="item-option" title="Inicio">
                <i id="boton-inicio">
    ...
    <script src="codigojs/galeriaUsuarioRegistrado.js"></script>
</body>
</html>