...
<body>
    ...
    <div id="video">
        <video id="primerVideo" autoplay muted loop src="videos/CastilloPepaPig.mp4"></video>
    </div>
    ...
    <div id="listaCategorias" class="lista-categorias" width="240px" height="60px">
    ...
    <script src="codigojs/catalogoS.js"></script>
</body>
</html>