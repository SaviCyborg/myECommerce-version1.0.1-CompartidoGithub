...
<head>
    ...
    <link rel="stylesheet"  type="text/css" href="estilos/estiloDel_IndexS.css">
...
<body>
    ...
    <aside id="aside" class="desplegar">
        <div class="container-svg">
            ...
            <div>
                ...
                <a href="catalogo.php">&nbspCatálogo</a>
            </div>
            <div>
    ...
    <header id="header">
        ...
        <div id="optionplace" class="options-place" >
            <div id="divboton-login" class="item-option" title="Ingresar o Crear una Cuenta">
                <a href="iniciarSesionS.php">
                    <i>
                        <svg id="login-icon" x="0px" y="0px" viewBox="0 0 258.75 258.75" style="enable-background:new 0 0 258.75 258.75;" xml:space="preserve" width="30px" height="30px">
            ...
            <div id="productsList" class="products-list">
                <div  id="productBox" class="product-box">
                    ...
                    if (isset($_GET['botonCategoria'])) {
                        ...
                        if ($_GET['datoCategoria'] == "Atracción") {
                        
                            $where=" where 1=1 and categoria like '%".$_GET['datoCategoria']."%'";
                        }else if ($_GET['datoCategoria'] == "Servicios") {
                        
                            $where=" where 1=1 and categoria like '%".$_GET['datoCategoria']."%'";
                        }else if ($_GET['datoCategoria'] == "Postres y Dulces") {
                        
                            $where=" where 1=1 and categoria like '%".$_GET['datoCategoria']."%'";
                        }else if ($_GET['datoCategoria'] == "Productos") {
                    ...
                    $sql = "SELECT 
                    `nombre`,`categoria`,`precioVenta`,`imagen`
                    FROM 
                    `park`
                    $where;
                    ";
    ...
    <script src="codigojs/codigoDel_indexS.js"></script>
</body>
</html>