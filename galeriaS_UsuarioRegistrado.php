...
<head>
    ...
    <link rel="stylesheet"  type="text/css" href="estilos/galeriaS_UsuarioRegistrado.css">  
</head>
<body>
<?php
    session_start();
    ...
    if (!isset($_SESSION['usuario'])) {
       header("Location:iniciarSesionS.php");
    }
?>
    <nav id="open-close">
        <span >
    ...
    <header id="header">
        ...
        <div id="optionplace" class="options-place" width='' height=''>
            ...
            <a href="indexS_UsuarioRegistrado.php" id="divboton-inicio" class="item-option" title="Inicio">
                <i id="boton-inicio">
    ...
    $query = "SELECT `imagen` FROM `epiz_32478908_empresa`.`galeria` WHERE '1=1'"; 
    ...
    ?>
        <img src="imagenesgaleria/<?php echo $row['imagen']; ?>" width="300px" height="280px">
    <?php
    }
    ?>
    ...
    <script src="codigojs/galeriaS_UsuarioRegistrado.js"></script>
</body>
</html>