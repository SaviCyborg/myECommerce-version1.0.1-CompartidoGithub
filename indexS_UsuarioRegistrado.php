...
<head>
    ...
    <link rel="stylesheet"  type="text/css" href="estilos/indexS_UsuarioRegistrado.css">
...
?>
    ...
    <aside id="aside" class="desplegar">
        <div class="container-svg">
            ...
            <div>
                ...
                <a href="catalogoUsuarioRegistradoS.php">&nbspCatálogo</a>
            </div>
            <div>
    ...
    <header id="header">
        ...
        <div id="searchplace" class="search-place" >
            <form id="primerFormulario" action="indexS.php" method="get" >
    ...
    <div id="video">
        <img id="primerVideo" src="imagenes/(1360pxWidth_x_591pxHeight)mySupermarket.png" width="100%" height="150px"></img>
    </div>
    ...
    <div id="listaCategorias" class="lista_categorias" width="240px" height="60px">
        <form action="indexS_UsuarioRegistrado.php" method="get"  >
                ...
                <div  id="productBox" class="product-box">
                    ...
                    <a href='<?php echo $url.'S.php?'.'nombre='.$nombre; ?>'>
                        <div class="product" >
                            ...
                            <form class="formulario_producto" action="indexS_UsuarioRegistrado.php" method="get">
                            ...
                            <img src='imagenesproductos/<?php echo $row['imagen']; ?>' width="65%" height="60%">
                            
                            <div class="info">
                                <?php echo $row['nombre']; ?>
                                / Categoría: <?php echo $row['categoria']; ?><br>
                                Precio: U$S &nbsp<?php echo $row['precioVenta']; ?>.<span class="spanDelPrecio"  >99</span>
                            </div>
    ...
    <script src="codigojs/indexS_UsuarioRegistrado.js "></script>
</body>
</html>