...
<head>
    ...
    <link rel="stylesheet"  type="text/css" href="estilos/indexUsuarioRegistrado.css">  
</head>
<body>
...
?>
    ...
    <header id="header">
        ...
        <div id="searchplace" class="search-place" >
            <form id="primerFormulario" action="indexUsuarioRegistrado.php" method="get" >
    ...
    <div id="video">
        <img id="primerVideo" src="imagenes/(1360pxWidth_x_591pxHeight)mySupermarket.png" width="100%"></img>
    </div>
    ...
    <div id="listaCategorias" class="lista_categorias" width="240px" height="60px">
        <form action="indexUsuarioRegistrado.php" method="get"  >
                ...
                <div  id="productBox" class="product-box">
                    ...
                    <a href='<?php echo $url.'.php?'.'nombre='.$nombre; ?>'>
                        <div class="product"  name='divProducto' width= '200px' height= '450px'>
                            ...
                            <form class="formulario_producto" action="indexUsuarioRegistrado.php" method="get">
                                ...
                                <button class="botonFavoritos" type="submit" value="" name="botonFavoritos">
                                    ...
                                    <?php
                                        include_once "datosConexion.php"; 
                                        $conexion5 = mysqli_connect($db_host,$db_user,$db_pass,$db_database);
                                        
                                        ini_set("display_errors",1);//quitando la tabla con errores para evitar ataques
                                        ini_set("display_startup_errors",1);//quitando la tabla con errores para evitar ataques
                                        
                                        if($conexion5==false){
                                            die("Error de conexion a MySQL con el codigo: ".mysqli_connect_errno($conexion5).
                                        "<br>".mysqli_connect_error($conexion5)
                                            );
                                        }
                                        ...
                                        ";
                                        $result2 = mysqli_query($conexion5,$query);
    ...
    <script src="codigojs/indexUsuarioRegistrado.js"></script>
</body>
</html>