...
<html lang="es">
    <head>
        ...
        <link rel="stylesheet"  type="text/css" href="estilos/estiloRegistrateS.css"> 
    </head>

    <body>
        <form class="form" action="registrateS.php" method="post">
            
            <h2 class="form__title">Regístrate</h2>
            <a href="indexS.php" class="form__link">Inicio</a>
            ...
            <input type="submit" class="form__submit" value="Regístrate" name="botonRegistrar">
        </form>

        <script src="codigojs/codigoRegistrateS.js"></script>
    ...
    if(!empty($_POST)){
        if (isset($_POST['botonRegistrar'])) {
            ...
            if ($Pass == $PassC) {
                ...
                (16, 'Helado Artesanal de pistacho', 'productos', 'productoss', '2022-01-01', '2022-01-01', 5, 45, 'heladoArtesanal-de-pistacho.jpeg', 'Helado Artesanal de pistacho'),
                (17, 'Helado Artesanal de Mango', 'productos', 'productoss', '2022-01-01', '2022-01-01', 5, 45, 'heladoArtesanalMango.png', 'Helado Artesanal de Mango'),
                (18, 'Helado Sundae Caramel', 'productos', 'productoss', '2022-01-01', '2022-01-01', 5, 45, 'heladoSundaeCaramel.png', 'Helado Sundae Caramel'),
                (19, 'Higos Secos', 'productos', 'productoss', '2022-01-01', '2022-01-01', 5, 45, 'higosSecos.jpg', 'Higos Secos'),
