...
<head>
    ...
    <link rel="stylesheet"  type="text/css" href="estilos/favoritosS.css">
...
<nav id="open-close">
    ...
    <header id="header">
        ...
        <div id="logo" class="logo-place">
            <img  id="imagen-logo" src="logo/savilogo(width300pxHeight300)T.png" width="40px" height="40px">
        </div>
       
        <div id="optionplace" class="options-place" width='' height=''>
            <div id="divboton-cierre" class="item-option" title="Cerrar Sesión">
                <a href="cierre.php">
                    <i>
            ...
            <div id="divboton-inicio" class="item-option" title="Inicio">
                <a href="indexUsuarioRegistrado.php">
                    <i id="boton-inicio">
            ...
            ?>
            <div class="item-option" id="divboton-login" title="<?php echo  $nombreUsuario; ?>">
                <a href="#">
                    <i >
        ...
        <div id="contentPage" class="content-page">
            ...
            <div id="productsList" class="products-list">
                <div  id="productBox" class="product-box">
                    ...
                    $where=" WHERE `favoritos` != 'NULL' ";  

                
                    $sql = "SELECT 
                    `favoritos`,`nombre`,`url`,`categoria`,`precioVenta`,`precioBolivares`,`imagen`,`descripcion`
                    FROM 
                    `epiz_32478908_empresa`.`favoritos_$nombreUsuario`
                    $where;
                    ";
                    ?>
                    ...
                    <a href='<?php echo $url.'S.php?'.'nombre='.$nombre; ?>'>
                        <div class="product"  name='divProducto' width= '200px' height= '450px'>
                            ...
                            <form class="formulario_producto" action="favoritosS.php" method="get">
                            ...
                            <img  name='imageProducto' src='imagenesproductos/<?php echo $row['imagen']; ?>' width="120px" height="90px">
                            ...
                            <div  class="detail-price" name='detailprice'>U$S <?php echo $row['precioVenta']; ?> . <span class="spanDelPrecio"  name='spanprecio'>99</span></div> 
    ...
    <script src="codigojs/favoritosS.js"></script>
</body>
</html>