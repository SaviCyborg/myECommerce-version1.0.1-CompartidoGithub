...
<head>
    ...
    <link rel="stylesheet"  type="text/css" href="estilosProductos/productosS.css">
...
<nav id="open-close">
    ...
    <aside id="aside" class="desplegar">
        <div class="container-svg">
            ...
            <div>
                ...
                <a href="catalogoUsuarioRegistrado.php">&nbspCatálogo</a>
            </div>
            <div>
    ...
    <header id="header">
        ...
        <div id="optionplace" class="options-place" width='' height=''>
            ...
            ?>
            <div id="user_icon" class="item-option" title="<?php echo  $nombreUsuario; ?>">
                <a  href="#">
                    <i>
    ...
    <?php
                ...
                $query = "SELECT `imagen`,`nombre` FROM `epiz_32478908_empresa`.`park` WHERE `nombre` = '$nombre' ";
    ...
    <div class="slideshow-container">
        ...
        <div class="mySlides fade">
            ...
            <img src='imagenesproductos/<?php echo "$imagen";?>' width="270px" height="180px">
            <div class="text"><?php echo " $nombre2";?></div>
        </div>
    ...
    <?php
                ...
                $query = "SELECT `precioVenta`,`precioBolivares`,`imagen`,`descripcion` FROM `epiz_32478908_empresa`.`park` WHERE `nombre` = '$nombre' ";
                ...
                if($row){
                    ...
                    $precioBolivares =  $row['precioBolivares'];
    ...
    <div class="info_container">
        <p >
           ...
           <span class="precio"> U$S <?php echo $precio;?> </span> 
           <span class="precioBolivares"> Bs. <?php echo $precioBolivares;?> </span>
           <span class="descuento"> 50% de descuento </span>
        </p>
        <a id="mediosDePago" href="mediosDePago.php">Ver los medios de pago</a>
        <a id="etiqueta_aComprar" href="datosCompra.php">Comprar</a>
    </div>
    ...
    <script src="codigojsproductos/productosS.js"></script>
</body>
</html>
