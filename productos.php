...
<head>
    ...
    <link rel="stylesheet"  type="text/css" href="estilosProductos/producto.css">
...
<nav id="open-close">
    ...
    <div class="slideshow-container">
        ...
        <div class="mySlides fade">
            ...
            <img src='imagenesproductos/<?php echo "$imagen";?>' width="650px" height="370px">
    ...
    <div class="info_container">
        ...
        <a id="etiqueta_aComprar" href="datosCompra.php">Comprar ahora</a>
    </div>
    ...
    <script src="codigojsproductos/producto.js"></script>
</body>
</html>
