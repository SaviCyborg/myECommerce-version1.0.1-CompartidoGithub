...
<head>
    ...
    <link rel="stylesheet"  type="text/css" href="estilos/estiloDel_Index.css">  
</head>
<body>
    <nav id="open-close">
        <span >
    ...
    <header id="header">
        ...
        <div id="searchplace" class="search-place" >
            <form id="primerFormulario" action="index.php" method="get" >
    ...
    <div id="video">
        <img id="primerVideo" src="imagenes/(1360pxWidth_x_591pxHeight)mySupermarket.png" ></img>
    </div>
    ...
    <script src="codigojs/codigoDel_index.js"></script>
</body>
</html>